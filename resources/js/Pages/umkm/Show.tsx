        ...
        <>
            <main className="container mx-auto">
                <div className="flex items-center mb-5 mt-10 justify-between">
                    <div>
                        <h1 className="text-xl font-medium ">Detail UMKM</h1>
                    </div>
                    <div>
                ...
                <section>
                    ...
                    <div className="mt-5">
                        <p className="text-primary font-medium">Tentang UMKM</p>
                    ...
                    <div className="mt-10">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href={umkm.tokopedia_link} target="_blank">
                                    Tokopedia{" "}
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href={umkm.instagram_link} target="_blank">
                                    Intagram
                                </a>
                            </li>
                            <li>
